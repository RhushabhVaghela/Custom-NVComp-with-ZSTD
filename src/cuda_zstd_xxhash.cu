...
constexpr u32 XXH64_STRIPE_LEN = 32;  // Process 32 bytes at a time

// ============================================================================
// ✅ FIXED: Changed __device__ to __device__ __host__ for all helper functions
// ============================================================================

__device__ __host__ __forceinline__ u64 xxh_rotl64(u64 x, u32 r) {
    return (x << r) | (x >> (64 - r));
}
...
__device__ __host__ __forceinline__ u32 xxh_rotl32(u32 x, u32 r) {
    return (x << r) | (x >> (32 - r));
}
...
__device__ u64 xxh64_finalize(XXH64_State& state) {
    u64 h64;
