 ...
 * @param workspace    Workspace for temporary buffers (frequencies, code_lengths, bit_offsets)
 ...
 * @param d_output          Device pointer to the output buffer for decompressed data.
